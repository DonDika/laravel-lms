...
@section('title', 'Search Courses - LMS DONDIKA')
...
@section('content')
    ...
    <div id="path" class="flex w-full bg-white border-b border-obito-grey py-[14px]">
        <div class="flex items-center w-full max-w-[1280px] px-[75px] mx-auto gap-5">
                ...
                <a href="{{ route('dashboard.subscription.details', $transaction) }}" class="last-of-type:font-semibold">Details Subscription</a>
        </div>
    </div>
